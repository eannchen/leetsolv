...
func TestValidationErrors(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "ErrInvalidLeetCodeURL",
			err:     ErrInvalidLeetCodeURL,
			userMsg: "Please provide a valid LeetCode problem URL",
		},
		{
			name:    "ErrInvalidLeetCodeURLFormat",
			err:     ErrInvalidLeetCodeURLFormat,
			userMsg: "Please provide a valid LeetCode problem URL format",
		},
		{
